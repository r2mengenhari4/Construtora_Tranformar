// Arquivo gerado e sincronizado automaticamente via Área de Membros da Construtora Transformar
import { SiteContent } from '../types/siteContent';

export const DEFAULT_SITE_CONTENT: SiteContent = {
  "hero": {
    "tagline": "Sua Obra Residencial Completa em Maricá e Região",
    "title": "Transforme seu sonho em realidade com",
    "titleHighlight": "Engenharia e Arquitetura Integradas",
    "subtitle": "Projetos modernos e obras residenciais de alto padrão com acompanhamento técnico contínuo, transparência de custos e cumprimento rigoroso de prazos em Maricá e região.",
    "backgroundImage": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1920&q=80",
    "ctaPrimaryText": "Quero Construir Minha Casa",
    "ctaSecondaryText": "Conhecer Nossos Projetos",
    "badge1": "Projetos e Obras Integrados",
    "badge2": "Responsabilidade Técnica (CREA)",
    "badge3": "Atuação Especializada em Maricá"
  },
  "allInOne": {
    "tagline": "Solução Completa",
    "title": "Construa sem Complicação com Nossa Solução All-in-One",
    "subtitle": "Do primeiro croqui até a entrega das chaves, cuidamos de cada detalhe com rigor técnico e transparência absoluta.",
    "marketTitle": "No Modelo Tradicional de Mercado",
    "marketDescription": "Contratar profissionais isolados gera descompasso entre arquitetura e engenharia, retrabalhos no canteiro, estouro de orçamento e cobranças extras imprevistas.",
    "marketConsequence": "Resultado: dor de cabeça, atrasos sucessivos e obras mais caras que o planejado.",
    "solutionTitle": "Com a Construtora Transformar",
    "solutionDescription": "Arquitetura, cálculo estrutural, instalações elétricas, hidráulicas e construção trabalham de forma coordenada desde o primeiro dia.",
    "solutionConsequence": "Resultado: obra previsível, economia real de materiais e você com a chave na mão.",
    "pillars": [
      {
        "id": "arquitetura",
        "title": "Arquitetura",
  ...
  "timeline": {
    "tagline": "Metodologia Construtiva",
    "title": "Do Terreno à Entrega das Chaves",
    "subtitle": "Um processo claro, estruturado e transparente em cada etapa da sua construção em Maricá.",
    "steps": [
      {
        "number": "01",
  ...
  "services": {
    ...
    "title": "Soluções Completas de Engenharia e Arquitetura",
    "subtitle": "Atendemos todas as necessidades do seu projeto ou obra com excelência técnica e foco em resultados.",
    "services": [
      {
  ...
  "portfolio": {
    "tagline": "Obras e Projetos",
    "title": "Nossas Obras e Projetos em Maricá",
    "subtitle": "Conheça algumas das residências projetadas e executadas pela Construtora Transformar na região."
  },
  "differentials": {
    "tagline": "Por Que Nos Escolher",
    "title": "O Que Torna a Transformar Diferente",
    "subtitle": "Princípios fundamentais que garantem a segurança e o sucesso do seu investimento.",
    "items": [
      {
        "title": "Planejamento",
  ...
  "about": {
    ...
    "paragraph1": "A Construtora Transformar nasceu para preencher uma lacuna no mercado da construção civil em Maricá: a falta de integração real entre quem projeta e quem executa.",
    "paragraph2": "Sob a liderança de engenheiros habilitados, unimos criatividade arquitetônica contemporânea com o cálculo estrutural exato e o acompanhamento diário no canteiro.",
    "paragraph3": "Acreditamos que construir sua residência deve ser uma experiência de realização e tranquilidade, nunca de desgaste ou incertezas.",
    ...
    "missionText": "Entregar residências de alto padrão e projetos com precisão técnica e transparência, proporcionando tranquilidade aos nossos clientes em cada metro quadrado construído.",
    "valuesTitle": "Nossos Valores",
    "valuesList": [
      "Ética e integridade nas relações",
      "Rigor técnico e respeito absoluto às normas da ABNT",
      "Cumprimento rigoroso de cronogramas e custos",
      "Comunicação aberta e relatórios periódicos"
    ],
    "teamTitle": "Corpo Técnico Qualificado",
    "teamText": "Equipe multidisciplinar composta por engenheiros civis, arquitetos, projetistas e mestres de obras experientes.",
    "teamLocation": "Sede e atuação em Maricá – RJ"
  },
  "contact": {
    "tagline": "Fale Conosco",
    "title": "Vamos Conversar Sobre a Sua Nova Casa?",
    "subtitle": "Agende uma visita ao nosso escritório ou solicite um atendimento preliminar para seu terreno.",
    "officeAddress": "Centro, Maricá - RJ",
    "officeMapsUrl": "https://maps.google.com/?q=Centro,Marica,RJ",
    "openingHours": "Segunda a Sexta, das 08h às 18h",
    "whatsappNumber": "5521999999999",
    "whatsappDisplay": "(21) 99999-9999",
    "whatsappDefaultMessage": "Olá! Gostaria de falar sobre um projeto de arquitetura e construção em Maricá com a Construtora Transformar.",
    "emailContact": "contato@construtoratransformar.com.br",
    "instagramHandle": "@construtoratransformar",
    "instagramUrl": "https://instagram.com/construtoratransformar"
  }
};

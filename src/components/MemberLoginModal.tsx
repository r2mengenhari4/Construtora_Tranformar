...
export const MemberLoginModal: React.FC = () => {
  ...
  const handleFillDefaultCredentials = () => {
    setIdentifier('rafael');
    setPassword('Engenharia781227@');
    setErrorMessage('');
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-3 border-t border-white/10 text-center">
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 transition-colors cursor-pointer"
                >
                  <Sparkles className="w-3 h-3" />
                  <span>Preencher dados de teste (Rafael)</span>
                </button>
              </div>
            </form>
          )}
